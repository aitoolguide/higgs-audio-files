...
def load_voice_presets():
    ...
    try:
        with open(
            os.path.join(os.path.dirname(__file__), "examples\\voice_prompts", "config.json"),
            "r",
        ) as f:
...
def get_voice_preset(voice_preset):
    ...
    voice_path = os.path.join(os.path.dirname(__file__), "examples\\voice_prompts", f"{voice_preset}.wav")
